...
support macOS and Linux; Windows users must install the latest release archive
manually. Treat a nonzero exit as a partial or failed upgrade and report the
